package SparkScala3.rdd.advanced
...
object DegreesOfSeparation {
  ...
  val startCharacterID = 4106 //SpiderMan
  val targetCharacterID = 859 //ADAM 3,031 (who?)
  ...
  def createStartingRdd(sc:SparkContext): RDD[BFSNode] = {
    val inputFile = sc.textFile("./src/main/scala/data/Marvel-graph.txt")
